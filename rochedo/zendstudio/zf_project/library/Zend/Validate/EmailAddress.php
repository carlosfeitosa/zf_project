...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID            => "Tipo inválido. O valor deve ser uma string",
        self::INVALID_FORMAT     => "'%value%' não é um endereço válido no formato básico email@servidor.com.br",
        self::INVALID_HOSTNAME   => "'%hostname%' não é um domínio válido para o endereço '%value%'",
        self::INVALID_MX_RECORD  => "'%hostname%' parece não aceitar recebimento de e-mails ou o domínio não existe para o endereço '%value%'",
