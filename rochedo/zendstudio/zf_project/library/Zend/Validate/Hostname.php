...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::UNDECIPHERABLE_TLD      => "'%value%' parece ser um domínio, mas não foi possível extrair seu prefixo (TLD part)",
        self::INVALID_HOSTNAME        => "'%value%' não tem a estrutura esperada para um domínio válido",
        self::INVALID_LOCAL_NAME      => "'%value%' parece não ser um domínio de rede válido",
        self::LOCAL_NAME_NOT_ALLOWED  => "'%value%' parece ser o nome de uma rede local, mas rede locais não são permitidas",
