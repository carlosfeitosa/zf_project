...
INSERT INTO basico.formulario  (id_categoria, ativo, nivel, nome, constante_textual, form_name, form_method, form_action, 
...
INSERT INTO basico.formulario  (id_categoria, ativo, nivel, nome, constante_textual, form_name, form_method, 
...
INSERT INTO basico.formulario  (id_categoria, ativo, nivel, nome, constante_textual, form_name, permite_rascunho, rowinfo)
SELECT c.id AS id_categoria,
	   true AS ativo,
	   1 AS nivel,
...
INSERT INTO basico.formulario  (id_categoria, id_formulario_pai, ativo, nivel, nome, constante_textual, form_name, form_method, form_action, 
...
INSERT INTO basico.formulario  (id_categoria, ativo, nivel, nome, constante_textual,
...
INSERT INTO basico.formulario  (id_categoria, id_formulario_pai, ativo, nivel, nome, constante_textual, form_name, form_attribs, ordem, permite_rascunho, rowinfo)
        SELECT c.id AS id_categoria,
        (SELECT f.id
        FROM basico.formulario  f
        WHERE f.nome = 'FORM_DADOS_USUARIO') AS id_formulario_pai,
...
INSERT INTO basico.formulario  (id_categoria, ativo, nivel, nome, constante_textual, form_name, form_method, form_action, form_attribs, permite_rascunho, rowinfo)
SELECT c.id AS id_categoria,
	   true AS ativo,
	   1 AS nivel,
