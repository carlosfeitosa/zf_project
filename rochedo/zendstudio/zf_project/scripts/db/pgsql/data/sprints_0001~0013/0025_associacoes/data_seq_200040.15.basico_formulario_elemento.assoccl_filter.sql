...
* 							04/07/2012 - adaptação dos scripts para os novos filters
* 						
*/

INSERT INTO basico_formulario_elemento.assoccl_filter (id_elemento, id_filter_grupo, ordem, rowinfo)
SELECT (SELECT fe.id 
	    ...
	    (SELECT fg.id
	     FROM basico_filter.grupo fg
	     LEFT JOIN basico.categoria cat ON (fg.id_categoria = cat.id)
	     ...
	     WHERE fg.nome = 'STRINGTRIM_STRIPTAGS'
