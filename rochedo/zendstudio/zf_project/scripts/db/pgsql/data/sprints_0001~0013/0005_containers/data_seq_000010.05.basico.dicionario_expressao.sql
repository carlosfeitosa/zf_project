...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DD_SCHEMA_BASICO' AS constante_textual, 'Schema básico do sistema' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DD_SCHEMA_BASICO_TABLE_CATEGORIA' AS constante_textual, 'Categorias do sistema' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DD_SCHEMA_BASICO_TABLE_CATEGORIA_FIELD_ID' AS constante_textual, 'Identificador' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DD_SCHEMA_BASICO_TABLE_CATEGORIA_FIELD_ID_TIPO_CATEGORIA' AS constante_textual, 'Tipo Categoria (id)' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CAMPO_EXIBICAO_CONSTANTE_TEXTUAL_ALIAS_BASICO_TIPO_CATEGORIA' AS constante_textual, 'Nome do tipo categoria' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VISAO_DADOS_USUARIO' AS constante_textual, 'Visão Dados Usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_VISAO' AS constante_textual, 'Visão' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_DADOS_GENERICOS' AS constante_textual, 'Dados Genéricos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'RACA' AS constante_textual, 'Raça' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'RACA_HUMANA' AS constante_textual, 'Raça Humana' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_CSS_LINKHTML_PASSWORD_STRENGTH_CHECKER' AS constante_textual, 'Include css para o componente password strength checker' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_JS_LINKHTML_PASSWORD_STRENGTH_CHECKER' AS constante_textual, 'Include javascript para o componente password strength checker' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_CSS_LINKHTML' AS constante_textual, 'Includes css recuperados pelo cliente HTTP' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_JS_LINKHTML' AS constante_textual, 'Includes javascript recuperados pelo cliente HTTP' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_INCLUDE' AS constante_textual, 'Includes' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_AREA_CONHECIMENTO_CURSO_ATUAL' AS constante_textual, 'Caixa de seleção de área de conhecimento' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_NOME_CURSO_ATUAL' AS constante_textual, 'Caixa de seleção de nome do curso atual' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_PERIODO' AS constante_textual, 'Caixa de seleção de período' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_TURNO' AS constante_textual, 'Caixa de seleção de turno' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_BUTTON_SUBMIT' AS constante_textual, 'Botão de submissão' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_BUTTON_RESET' AS constante_textual, 'Botão de resetar' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_BUTTON_CLOSE_DIALOG' AS constante_textual, 'Botão de fechar caixa de diálogo' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_BUTTON_DIALOG_DOJO' AS constante_textual, 'Botão de caixa de diálogo DOJO' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_PROFISSAO' AS constante_textual, 'Caixa de seleção de profissão' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_VINCULO_PROFISSIONAL' AS constante_textual, 'Caixa de seleção de vínculo profissional' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_PJ_VINCULO' AS constante_textual, 'Caixa de seleção de vínculo de pessoa jurídica' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_REGIME_TRABALHO' AS constante_textual, 'Caixa de seleção de regime de trabalho' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_CARGO' AS constante_textual, 'Caixa de validação cargo' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_FUNCAO' AS constante_textual, 'Caixa de validação função' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_SIMPLE_TEXT_AREA_ATIVIDADES_DESENVOLVIDAS' AS constante_textual, 'Área de texto simples de atividades desenvolvidas' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_DATE_TEXT_BOX_DATA_ADMISSAO' AS constante_textual, 'Caixa de texto DATA/HORA de data de admissão' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_DATE_TEXT_BOX_DATA_DESVINCULACAO' AS constante_textual, 'Caixa de texto DATA/HORA de data de desvinculação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NUMBER_TEXT_BOX_CARGA_HORARIA_SEMANAL' AS constante_textual, 'Caixa de texto para números de carga horária semanal' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CURRENCY_TEXT_BOX_SALARIO_BRUTO' AS constante_textual, 'Caixa de texto de moeda corrente de salário bruto' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CHECK_BOX_DEDICACAO_EXCLUSIVA' AS constante_textual, 'Caixa de verificação de dedicação exclusiva' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_SIMPLE_TEXT_AREA_OUTRAS_INFORMACOES' AS constante_textual, 'Área de texto simples de outras informação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_LINHA_HORIZONTAL' AS constante_textual, 'Linha horizontal' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_MULTI_CHECK_BOX_PERFIS_DISPONIVEIS' AS constante_textual, 'Caixa de verificação de múltiplos valores de perfis disponíveis' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_PASSWORD_TEXT_BOX_SENHA_ATUAL' AS constante_textual, 'Caixa de texto de password de senha atual' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_PASSWORD_TEXT_BOX_NOVA_SENHA' AS constante_textual, 'Caixa de texto de password de nova senha' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_PASSWORD_TEXT_BOX_CONFIRMACAO_NOVA_SENHA' AS constante_textual, 'Caixa de texto de password de confirmação de nova senha' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_ELEMENT_HTML_TEXT_INSTRUCOES_MUDANCA_SENHA_SUBFORM_DADOS_USUARIO_CONTA' AS constante_textual, 'Elemento HTML de instruções de mudança de senha' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_PERFIS_VINCULADOS_DISPONIVEIS' AS constante_textual, 'Caixa de seleção de perfis vinculados disponíveis' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_TELEFONE_TIPO' AS constante_textual, 'Caixa de seleção de tipo de telefone' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_FORM_FIELD_NUMBER_TEXT_BOX_TELEFONE_CODIGO_PAIS' AS constante_textual, 'Caixa de seleção de código DDI' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NUMBER_TEXT_BOX_TELEFONE_CODIGO_AREA' AS constante_textual, 'Caixa de seleção de código DDD' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NUMBER_TEXT_BOX_TELEFONE' AS constante_textual, 'Caixa de texto de números para telefone' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NUMBER_TEXT_BOX_TELEFONE_RAMAL' AS constante_textual, 'Caixa de texto de números para ramais telefônicos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_SIMPLE_TEXT_AREA_TELEFONE_DESCRICAO' AS constante_textual, 'Área de texto simples para descrição de número de telefone' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_EMAIL_TIPO' AS constante_textual, 'Caixa de seleção de tipo de email' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_SIMPLE_TEXT_AREA_EMAIL_DESCRICAO' AS constante_textual, 'Área de texto simples para descrição de email' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_FILTERING_SELECT_WEBSITE_TIPO' AS constante_textual, 'Caixa de seleção de tipo de website' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'LEGENDA' AS constante_textual, 'Legenda' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ACOES' AS constante_textual, 'Ações' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ACEITE' AS constante_textual, 'Aceite' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DOWNLOAD' AS constante_textual, 'Download' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_USUARIO' AS constante_textual, 'Dados do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_PESSOAIS' AS constante_textual, 'Dados pessoais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'MAIOR_TITULACAO' AS constante_textual, 'Maior titulação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CURSO_ATUAL' AS constante_textual, 'Curso atual' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'COORDENACAO_POS_GRADUACAO' AS constante_textual, 'Coordenação de pós-graduação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ORIENTACOES' AS constante_textual, 'Orientações' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_NASCIMENTO' AS constante_textual, 'Dados do Nascimento' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FILIACAO' AS constante_textual, 'Filiação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DOCUMENTOS_PESSOAIS' AS constante_textual, 'Documentos pessoais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INFORMACOES_CONTATO' AS constante_textual, 'Informações de contato' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VINCULO_PADRAO' AS constante_textual, 'Vínculo padrão' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'TROCA_DE_SENHA' AS constante_textual, 'Troca de senha' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'TENTATIVA_REGISTRO_UTILIZANDO_EMAIL_PRIMARIO' AS constante_textual, 'Tentativa de registro utilizando email primário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VALIDACAO_USUARIO' AS constante_textual, 'Validação de usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VALIDACAO_USUARIO_PLAINTEXT_REENVIO' AS constante_textual, 'Reenvio de validação de usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CONFIRMACAO_CADASTRO' AS constante_textual, 'Confirmação de cadastro' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'PROBLEMAS_LOGIN' AS constante_textual, 'Problemas no Login' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_LABEL_ESCAPE' AS constante_textual, 'Decorator Label Escape' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_LABEL_ESCAPE_WRAP_LABEL_RIGHT' AS constante_textual, 'Decorator Label Escape Wrap Label Right' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_TAB_CONTAINER1' AS constante_textual, 'Decorator Tab Container 1' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_ACCORDION_CONTAINER1' AS constante_textual, 'Decorator Accordion Container 1' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_CONTENT_PANE1' AS constante_textual, 'Decorator Content Pane 1' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_SUBFORM_CONTENT_PANE1' AS constante_textual, 'Decorator SubForm Content Pane 1' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV' AS constante_textual, 'Decorator Form Field Div' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_MARGIN_RIGHT_10PX' AS constante_textual, 'Decorator Form Field Div Margin Right 10 pixels' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_WIDTH_100PERCENT_CLEAR_BOTH' AS constante_textual, 'Decorator Form Field Div Width 100 Percent Clear Both' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_RIGHT' AS constante_textual, 'Decorator Form Field Div Float Right' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_RIGHT_CLEAR_BOTH' AS constante_textual, 'Decorator Form Field Div Float Right Clear Both' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_RIGHT_MARGIN_RIGHT_10px' AS constante_textual, 'Decorator Form Field Div Float Right Margin Right 10 Pixels' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_LEFT_MARGIN_RIGHT_10PX' AS constante_textual, 'Decorator Form Field Div Float Left Margin Right 10 Pixels' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_LEFT' AS constante_textual, 'Decorator Form Field Div Float Left' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_LEFT_CLEAR_BOTH_MARGIN_RIGHT_10PX' AS constante_textual, 'Decorator Form Field Div Float Left Clear Both Margin Right 10 Pixels' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_FLOAT_LEFT_CLEAR_BOTH' AS constante_textual, 'Decorator Form Field Div Float Left Clear Both' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_CLEAR_BOTH' AS constante_textual, 'Decorator Form Field Div Clear Both' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_FORM_FIELD_DIV_WIDTH_300PX' AS constante_textual, 'Decorator Form Field Div Width 300 Pixels' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_ADMIN_RASCUNHOS' AS constante_textual, 'Formulário para administração de rascunhos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_ACEITE_TERMOS_USO' AS constante_textual, 'Formulário para aceitação dos termos de uso' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_TROCA_DE_SENHA' AS constante_textual, 'Formulário para troca de senha' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_SUGESTAO_LOGIN' AS constante_textual, 'Formulário para sugestão de login' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DADOS_USUARIO' AS constante_textual, 'Formulário de dados do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_DADOS_ACADEMICOS' AS constante_textual, 'Sub-formulário de dados acadêmicos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_COORDENACAO_POS_GRADUACAO' AS constante_textual, 'Formulário de coordenação de cursos de pós-graduação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_ORIENTACOES' AS constante_textual, 'Formulário de Orientandos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_DADOS_PROFISSIONAIS' AS constante_textual, 'Sub-formulário de dados profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_DADOS_BIOMETRICOS' AS constante_textual, 'Sub-formulário de dados biométricos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_CONTA' AS constante_textual, 'Sub-formulário de dados da conta do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_VINCULO_PROFISSIONAL' AS constante_textual, 'Formulário de vinculos profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_TELEFONES_PROFISSIONAIS' AS constante_textual, 'Formulário de cadastro/edição de telefones profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_EMAILS_PROFISSIONAIS' AS constante_textual, 'Formulário de cadastro/edição de emails profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_WEBSITES_PROFISSIONAIS' AS constante_textual, 'Formulário de cadastro/edição de websites profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_ENDERECOS_PROFISSIONAIS' AS constante_textual, 'Formulário de cadastro/edição de endereços profissionais' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_TELEFONE' AS constante_textual, 'Formulário de cadastro/edição de telefones' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_EMAIL' AS constante_textual, 'Formulário de cadastro/edição de emails' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_WEBSITE' AS constante_textual, 'Formulário de cadastro/edição de websites' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_ENDERECO' AS constante_textual, 'Formulário de cadastro/edição de endereços' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_CADASTRAR_USUARIO_NAO_VALIDADO' AS constante_textual, 'Formulário de cadastro de usuários NÃO validados' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_CADASTRAR_USUARIO_VALIDADO' AS constante_textual, 'Formulário de cadastro de usuários validados' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_DOCUMENTOS_IDENTIFICACAO' AS constante_textual, 'Formulário para listar de documentos de identificação' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_DOCUMENTO' AS constante_textual, 'Formulário de cadastro/edição de documentos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_AUTENTICACAO_USUARIO' AS constante_textual, 'Formulário para autenticação de usuarios' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_DADOS_PESSOAIS' AS constante_textual, 'Sub-formulário para edição dos dados pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_DOCUMENTOS_PESSOAIS' AS constante_textual, 'Formulário para listagem dos documentos pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_TELEFONES_PESSOAIS' AS constante_textual, 'Formulário para listagem dos telefones pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_EMAILS_PESSOAIS' AS constante_textual, 'Formulário para listagem dos emails pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_WEBSITES_PESSOAIS' AS constante_textual, 'Formulário para listagem dos websites pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_ENDERECOS_PESSOAIS' AS constante_textual, 'Formulário para listagem dos endereços pessoais do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_INFORMACOES_BANCARIAS' AS constante_textual, 'Sub-formulário para cadastro/edição de informações bancários do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_INFORMACOES_BANCARIAS_DADOS_BANCARIOS' AS constante_textual, 'Sub-formulário para cadastro/edição de dados bancários do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_CONTAS_BANCARIAS' AS constante_textual, 'Formulário para listagem de contas bancárias do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'SUBFORM_DADOS_USUARIO_INFORMACOES_BANCARIAS_MOVIMENTACAO_FINANCEIRA' AS constante_textual, 'Sub-formulário para cadastro/edição de movimentação financeira do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_DIALOG_CONTA_BANCARIA' AS constante_textual, 'Sub-formulário para cadastro/edição de contas bancárias do usuário' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_RESOLVEDOR_CONFLITO_VERSAO_OBJETO' AS constante_textual, 'Formulário para resolver conflitos de versão de objetos' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_DOJO' AS constante_textual, 'Output Dojo' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_HTML' AS constante_textual, 'Output Html' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_AJAX' AS constante_textual, 'Output Ajax' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_MODULO_DEFAULT' AS constante_textual, 'Default' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_MODULO_BASICO' AS constante_textual, 'Básico' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_LINGUAGEM' AS constante_textual, 'Linguagem' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_FORM' AS constante_textual, 'Formulário HTML.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_FORM' AS constante_textual, 'Componente HTML formulário para submissão de dados.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_FORM_SUBFORM' AS constante_textual, 'Sub-formulário HTML.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_FORM_SUBFORM' AS constante_textual, 'Componente HTML sub-formulário para submissão de dados.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_DOJO_FORM' AS constante_textual, 'Formulário DOJO.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_DOJO_FORM' AS constante_textual, 'Componente DOJO formulário para submissão de dados.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_DOJO_FORM_SUBFORM' AS constante_textual, 'Sub-formulário DOJO.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_DOJO_FORM_SUBFORM' AS constante_textual, 'Componente DOJO sub-formulário para submissão de dados.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_REGEX' AS constante_textual, 'Componente ZF validator regular expressions (regex).' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_ALNUM' AS constante_textual, 'Componente ZF validator alphanumeric (alnum).' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_IDENTICAL' AS constante_textual, 'Componente ZF validator identical.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_STRING_LENGTH' AS constante_textual, 'Componente ZF validator string length.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_NOT_EMPTY' AS constante_textual, 'Componente ZF validator not empty.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_INT' AS constante_textual, 'Componente ZF validator integer (int).' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_VALIDATOR_EMAIL_ADDRESS' AS constante_textual, 'Componente ZF validator e-mail address.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_FILTER_STRING_TRIM' AS constante_textual, 'Componente ZF filter string trim.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_ZF_FILTER_STRIP_TAGS' AS constante_textual, 'Componente ZF filter strip tags.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_REGEX' AS constante_textual, 'Componente ZF para validação de string através de expressões regulares (regex).' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_ALNUM' AS constante_textual, 'Componente ZF para validação de string alfa-numéricas (alnum).' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_IDENTICAL' AS constante_textual, 'Componente ZF para validação de string identicas.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_STRING_LENGTH' AS constante_textual, 'Componente ZF para validação de tamanho de strings.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_NOT_EMPTY' AS constante_textual, 'Componente ZF para validação string não vazia.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_INT' AS constante_textual, 'Componente ZF para validação de números inteiros.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_VALIDATOR_EMAIL_ADDRESS' AS constante_textual, 'Componente ZF para validação endereços de e-mail.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_FILTER_STRING_TRIM' AS constante_textual, 'Componente ZF para limpeza de espaços em branco no início e final de um texto.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DESCRICAO_ZF_FILTER_STRIP_TAGS' AS constante_textual, 'Componente ZF para limpeza código (tags) dentro de um texto.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_WEBSITE_ENDERECO' AS constante_textual, 'Caixa de texto para digitação do endereço do website.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_SIMPLE_TEXT_AREA_WEBSITE_DESCRICAO' AS constante_textual, 'Caixa de texto para digitação da descrição do website.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_NOME_USUARIO' AS constante_textual, 'Caixa de texto para digitação do nome do Usuário.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_VALIDATION_TEXT_BOX_EMAIL_USUARIO' AS constante_textual, 'Caixa de texto para digitação do email do Usuário.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CAPTCHA_6' AS constante_textual, 'Caixa de texto para digitação da verificação de segurança ant-span' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_HASH' AS constante_textual, 'Hash para segurança do formulário.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_PAIS_NASCIMENTO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do País de nascimento.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ESTADO_NASCIMENTO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do Estado de nascimento.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ESTADO_NASCIMENTO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do Estado de nascimento.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_MUNICIPIO_NASCIMENTO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do Município de nascimento.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_MUNICIPIO_NASCIMENTO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do Município de nascimento.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NOME_PAI_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do nome do do Pai.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_NOME_MAE_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do nome da Mãe.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_TIPO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do tipo de endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_PAIS_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do País do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_ESTADO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do Estado do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_ESTADO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do Estado do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_MUNICIPIO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do Município do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_MUNICIPIO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do Município do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_CEP_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do CEP do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_LOGRADOURO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do logradouro do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_NUMERO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do número do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_ENDERECO_COMPLEMENTO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do complemento do endereço.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_NUMERO_BANCO_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do número do banco.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_BANCO_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do banco da conta bancária.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_AGENCIA_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação da agência bancária da conta.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_TIPO_CONTA_FILTERING_SELECT' AS constante_textual, 'Caixa de seleção do tipo da conta bancária.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_NUMERO_CONTA_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação do número da conta bancária.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_FIELD_CONTA_BANCARIA_DESCRICAO_IDENTIFICACAO_CONTA_VALIDATION_TEXT_BOX' AS constante_textual, 'Caixa de texto para digitação da identificação da conta bancária.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_HTML_TEXT_DESCRICAO_FORM_RESOLVEDOR_CONFLITO_VERSAO_OBJETO' AS constante_textual, 'Texto sobre resolução de conflito de versão.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_HTML_TEXT_DESCRICAO_BUTTON_VISUALIZAR_DADOS_ATUAIS_FORM_RESOLVEDOR_CONFLITO_VERSAO_OBJETO' AS constante_textual, 'Texto com descrição do botão visualizar dado atuais  do formulário de resolução de conflito.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FORM_HTML_TEXT_DESCRICAO_BUTTON_REVISAR_DADOS_ATUAIS_FORM_RESOLVEDOR_CONFLITO_VERSAO_OBJETO' AS constante_textual, 'Texto com descrição do botão revisar dado atuais do formulário de resolução de conflito.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'pt-br';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DECORATOR_AJAX_FORM' AS constante_textual, 'Decorator to ajax form subimissions.' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VISAO_DADOS_USUARIO' AS constante_textual, 'User Data View' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_VISAO' AS constante_textual, 'View' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_DADOS_GENERICOS' AS constante_textual, 'Generic Data' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'RACA' AS constante_textual, 'Race' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'RACA_HUMANA' AS constante_textual, 'Human Race' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_CSS_LINKHTML_PASSWORD_STRENGTH_CHECKER' AS constante_textual, 'Css include for password strength checker component' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_JS_LINKHTML_PASSWORD_STRENGTH_CHECKER' AS constante_textual, 'Javascript include for password strength checker component' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_CSS_LINKHTML' AS constante_textual, 'Css includes recovered by HTTP client' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INCLUDE_JS_LINKHTML' AS constante_textual, 'Javascript includes recovered by HTTP client' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'LEGENDA' AS constante_textual, 'Subtitle' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ACOES' AS constante_textual, 'Actions' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ACEITE' AS constante_textual, 'Acceptance' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_USUARIO' AS constante_textual, 'User data' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_PESSOAIS' AS constante_textual, 'Personal data' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'MAIOR_TITULACAO' AS constante_textual, 'Highest degree' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CURSO_ATUAL' AS constante_textual, 'Actual course' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'COORDENACAO_POS_GRADUACAO' AS constante_textual, 'Post-graduation coordination' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'ORIENTACOES' AS constante_textual, 'Orientations' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DADOS_NASCIMENTO' AS constante_textual, 'Birth data' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'FILIACAO' AS constante_textual, 'Sonship' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'DOCUMENTOS_PESSOAIS' AS constante_textual, 'Personal documents' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'INFORMACOES_CONTATO' AS constante_textual, 'Contact information' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VINCULO_PADRAO' AS constante_textual, 'Standard link' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'TROCA_DE_SENHA' AS constante_textual, 'Password change' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'TENTATIVA_REGISTRO_UTILIZANDO_EMAIL_PRIMARIO' AS constante_textual, 'Attempt to log in using primary email' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VALIDACAO_USUARIO' AS constante_textual, 'User validation' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'VALIDACAO_USUARIO_PLAINTEXT_REENVIO' AS constante_textual, 'Forwarding user validation' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'CONFIRMACAO_CADASTRO' AS constante_textual, 'Confirmation of registration' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_DOJO' AS constante_textual, 'Dojo Output' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_HTML' AS constante_textual, 'Html Output' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'OUTPUT_AJAX' AS constante_textual, 'Ajax Output' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_MODULO_BASICO' AS constante_textual, 'Basic' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
...
INSERT INTO basico.dicionario_expressao (id_categoria, constante_textual, traducao, ativo, rowinfo)
SELECT c.id, 'NOME_TIPO_CATEGORIA_LINGUAGEM' AS constante_textual, 'Language' AS traducao, true AS ativo, 'SYSTEM STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT JOIN basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'LINGUAGEM'
AND c.nome = 'en-us';
