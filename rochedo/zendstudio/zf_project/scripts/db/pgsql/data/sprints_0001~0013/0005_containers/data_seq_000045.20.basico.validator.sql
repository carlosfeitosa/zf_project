...
SELECT c.id AS id_categoria, 'REGEX_/^[(a-zA-Z)]+[(a-zA-Z0-9_@\.)]*$/' AS nome,
		(SELECT constante_textual 
		 FROM basico.dicionario_expressao 
		 WHERE constante_textual = 'NOME_VALIDATOR_REGEX_/^[(a-zA-Z)]+[(a-zA-Z0-9_@\.)]*$/') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_ALNUM_WITHOUT_WHITESPACES') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_IDENTICAL') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_STRING_LENGTH_6_TO_100') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_STRING_LENGTH_3_TO_100') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_NOT_EMPTY') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_INT') AS constante_textual,
       '\'Int'\' AS validator, 
       'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_EMAIL_ADDRESS') AS constante_textual,
...
(SELECT constante_textual 
 FROM basico.dicionario_expressao 
 WHERE constante_textual = 'NOME_VALIDATOR_EMAIL_ADDRESS_DEEP_MX') AS constante_textual,
