...
SELECT c.id AS id_categoria,
	   ...
	   '''escape'' => false, ''disableFor'' => true' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''escape'' => false, ''disableFor'' => true, ''placement'' => ''append''' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''id'' => ''TabContainer'', ''style'' => ''width: 850px; height: 430px; top: 10px; position: relative; z-index: 3;'', ''dijitParams'' => array(''tabPosition'' => ''top'')' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''id'' => ''AccordionContainer'', ''style'' => ''width: 850px; height: 430px; position: relative; z-index: 3;'',' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''id'' => ''ContentPane'', ''style'' => ''width: 850px; height: 430px; position: relative; z-index: 3;'',' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''id'' => ''@nomeElemento'', ''title'' => ''@tituloContentPane'',' AS attribs,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''margin-right10px''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''width100percent-clear-both''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-right''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-right-clear-both''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-right-margin-right10px''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-left-margin-right10px''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-left''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-left-clear-both-margin-right10px''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''float-left-clear-both''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''id'' => ''clear-both''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
...
SELECT c.id AS id_categoria,
	   ...
	   '''tag'' => ''div'', ''style'' => ''width: 300px;''' AS attribs,
	   'row' AS alias,
	   true AS ativo, 
	   'SYSTEM_STARTUP' AS rowinfo
FROM basico.tipo_categoria t
