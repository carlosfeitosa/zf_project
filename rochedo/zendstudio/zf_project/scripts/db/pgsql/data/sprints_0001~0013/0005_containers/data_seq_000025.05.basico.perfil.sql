...
SELECT id, 'USUARIO_PUBLICO' AS nome, 100 AS prioridade, 
...
INSERT INTO basico.perfil (id_categoria, nome, constante_textual, prioridade, constante_textual_descricao, ativo, rowinfo)
SELECT id, 'USUARIO_NAO_VALIDADO' AS nome, 'PERFIL_USUARIO_NAO_VALIDADO' AS constante_textual,200 AS prioridade,
...
INSERT INTO basico.perfil (id_categoria, nome, constante_textual, prioridade, constante_textual_descricao,  ativo, rowinfo)
SELECT id, 'USUARIO_VALIDADO' AS nome, 'PERFIL_USUARIO_VALIDADO' AS constante_textual, 300 AS prioridade, 
