...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_TENTATIVA_REGISTRO_UTILIZANDO_EMAIL_PRIMARIO_PLAINTEXT_en-us' AS nome,
true AS ativo,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_TENTATIVA_REGISTRO_UTILIZANDO_EMAIL_PRIMARIO_PLAINTEXT_pt-br' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_VALIDACAO_USUARIO_PLAINTEXT_pt-br' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Confirmação de Registro' AS assunto,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_VALIDACAO_USUARIO_PLAINTEXT_en-us' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Registration Confirmation' AS assunto,
'Dear @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_VALIDACAO_USUARIO_PLAINTEXT_REENVIO_pt-br' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Reenvio de confirmação de Registro' AS assunto,
'Prezado(a) sr.(a) @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_VALIDACAO_USUARIO_PLAINTEXT_REENVIO_en-us' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Forwarding confirmation of registration' AS assunto,
'Dear @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_CONFIRMACAO_CADASTRO_PLAINTEXT_pt-br' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Registro Concluído' AS assunto,
'@tratamento @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_CONFIRMACAO_CADASTRO_PLAINTEXT_en-us' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Registration Completed' AS assunto,
'@tratamento @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_PROBLEMAS_LOGIN_PLAINTEXT_pt-br' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Problema(s) com seu login' AS assunto,
'@tratamento @nomeUsuario,
...
INSERT INTO basico.mensagem (nome, ativo, remetente, destinatarios, assunto, mensagem, id_categoria, datahora_criacao, rowinfo)
SELECT 'SISTEMA_MENSAGEM_EMAIL_TEMPLATE_PROBLEMAS_LOGIN_PLAINTEXT_en-us' AS nome, 
true AS ativo,
'SYSTEM_STARTUP' AS remetente, 'SYSTEM_STARTUP' AS destinatarios, 'Problem(s) with your login' AS assunto,
'@tratamento @nomeUsuario,
