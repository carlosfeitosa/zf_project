...
* 								28/06/2011 - criacao de formularios elementos para o formulario FORM_DIALOG_SUGESTAO_LOGIN;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        AND fe.nome = 'FORM_FIELD_FILTERING_SELECT_FORMULARIO') AS id_formulario_elemento,
        (SELECT d.id
        FROM decorator d
        ...
        (SELECT g.id
       	...
       	WHERE g.nome = 'FILTROS') AS id_grupo_formulario_elemento,
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_FILTERING_SELECT_TIPO_DATA') AS id_formulario_elemento,
        (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_DATE_TEXT_BOX_DATA_INICIO_PERIODO') AS id_formulario_elemento,
        (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_DATE_TEXT_BOX_DATA_TERMINO_PERIODO') AS id_formulario_elemento,
        (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
INSERT INTO formulario_formulario_elemento (id_formulario, id_formulario_elemento, id_decorator, element_name, element_required, ordem, rowinfo)
SELECT (SELECT f.id
        FROM formulario f
        LEFT JOIN categoria c ON (f.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
       ...
       (SELECT fe.id
        ...
        AND fe.nome = 'FORM_FIELD_HTML_CONTENT_DINAMICO') AS id_formulario_elemento,
        (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
INSERT INTO formulario_formulario_elemento (id_formulario, id_formulario_elemento, id_decorator, element_name, id_grupo_formulario_elemento, element_required, ordem, rowinfo)
SELECT (SELECT f.id
        FROM formulario f
        LEFT JOIN categoria c ON (f.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
       ...
       (SELECT fe.id
        ...
        (SELECT g.id
       	FROM grupo_formulario_elemento g
       	WHERE g.nome = 'LEGENDA') AS id_grupo_formulario_elemento,
...
SELECT (SELECT f.id
       ...
       (SELECT d.id
        ...
        (SELECT g.id
       	FROM grupo_formulario_elemento g
       	WHERE g.nome = 'ACOES') AS id_grupo_formulario_elemento,
