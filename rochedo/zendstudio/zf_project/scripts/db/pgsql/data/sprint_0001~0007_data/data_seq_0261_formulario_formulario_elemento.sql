...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        AND fe.nome = 'FORM_FIELD_RG') AS id_formulario_elemento, false AS element_required, 1 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_CPF') AS id_formulario_elemento, false AS element_required, 2 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_CNH') AS id_formulario_elemento, false AS element_required, 3 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_PASSAPORTE') AS id_formulario_elemento, false AS element_required, 4 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO_BUTTON'
        AND fe.nome = 'FORM_BUTTON_SUBMIT') AS id_formulario_elemento, false AS element_required, 8 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        false AS element_required, 21 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_TELEFONE_TIPO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_EMAIL_TIPO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_EMAIL_DESCRICAO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_WEBSITE_TIPO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_WEBSITE_ENDERECO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_WEBSITE_DESCRICAO') AS id_formulario_elemento,
       (SELECT d.id
        FROM decorator d
        LEFT JOIN categoria c ON (d.id_categoria = c.id)
        LEFT JOIN tipo_categoria t ON (c.id_tipo_categoria = t.id)
