...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        AND fe.nome = 'FORM_FIELD_RG') AS id_formulario_elemento, 0 AS element_required, 1 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_CPF') AS id_formulario_elemento, 0 AS element_required, 2 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_CNH') AS id_formulario_elemento, 0 AS element_required, 3 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO'
        AND fe.nome = 'FORM_FIELD_PASSAPORTE') AS id_formulario_elemento, 0 AS element_required, 4 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
...
SELECT (SELECT f.id
       ...
       (SELECT fe.id
        ...
        WHERE t.nome = 'FORMULARIO'
        AND c.nome = 'FORMULARIO_ELEMENTO_BUTTON'
        AND fe.nome = 'FORM_BUTTON_SUBMIT') AS id_formulario_elemento, 0 AS element_required, 8 AS ordem, 'SYSTEM_STARTUP' AS rowinfo;
