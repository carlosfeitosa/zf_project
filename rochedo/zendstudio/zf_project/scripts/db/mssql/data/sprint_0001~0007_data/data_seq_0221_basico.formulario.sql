...
INSERT INTO basico.formulario (id_categoria, nome, descricao, 
        ...
        NULL AS form_attribs, 0 AS permite_rascunho, 'SYSTEM_STARTUP' AS rowinfo       
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'FORMULARIO'
AND c.nome = 'FORMULARIO_ADMIN_RASCUNHOS';

INSERT INTO basico.formulario (id_categoria, id_decorator, nome, descricao, 
                        constante_textual_titulo, constante_textual_subtitulo,
...
INSERT INTO basico.formulario (id_categoria, id_formulario_pai, nome, descricao, 
                        constante_textual_titulo,form_name, form_method, form_action, 
...
INSERT INTO basico.formulario (id_categoria, nome, descricao, 
        ...
        'post' AS form_method, NULL AS form_action, 
        NULL AS form_attribs, 0 AS permite_rascunho,
        'SYSTEM_STARTUP' AS rowinfo       
FROM basico.tipo_categoria t
LEFT join basico.categoria c ON (t.id = c.id_tipo_categoria)
WHERE t.nome = 'FORMULARIO'
...
INSERT INTO basico.formulario (id_categoria, id_decorator, id_formulario_pai, nome, descricao, 
                        constante_textual_titulo,form_name, form_method, form_action, 
                        form_attribs, ordem, rowinfo)
        SELECT c.id AS id_categoria,
		(SELECT d.id
...
INSERT INTO basico.formulario (id_categoria, id_decorator, id_formulario_pai, nome, descricao, 
                        constante_textual_titulo,form_name, form_attribs, ordem, permite_rascunho,
                        rowinfo)
        SELECT c.id AS id_categoria,
		(SELECT d.id
	         d
