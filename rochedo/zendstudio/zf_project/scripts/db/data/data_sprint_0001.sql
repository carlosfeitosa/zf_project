...
VALUES ('SYSTEM_STARTUP', 'SYSTEM_STARTUP', 'Confirmação de Registro', 'Prezado(a) [nome_usuario], para continuar o seu cadastro no Rochedo Project, clique no link abaixo: [link]', @LAST_ID_PAI, 'SYSTEM_STARTUP', getDate())
INSERT INTO [dbo].[CATEGORIA]([ID_TIPO_CATEGORIA], [NIVEL], [NOME], [DESCRICAO], [ROWINFO])
