...
SET @LAST_ID_PAI = @@IDENTITY
INSERT INTO [dbo].[MENSAGEM] ([ASSUNTO], [MENSAGEM], [ID_CATEGORIA], [ROWINFO], [DATAHORA_MENSAGEM])
VALUES ('Confirmação de Registro', 'Prezado(a) [nome_usuario], para continuar o seu cadastro no Rochedo Project, clique no link abaixo: [link]', @LAST_ID_PAI, 'SYSTEM_STARTUP', getDate())
INSERT INTO [dbo].[CATEGORIA]([ID_TIPO_CATEGORIA], [NIVEL], [NOME], [DESCRICAO], [ROWINFO])
