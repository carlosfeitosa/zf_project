			...
			.declare(
							...
							dijit.form._FormMixin, dijit._DialogMixin ],
					{
						...
						attributeMap : dojo.delegate(
								dijit._Widget.prototype.attributeMap, {
									title : [ {
										node : "titleNode",
										type : "innerHTML"
									}, {
						...
						postMixInProperties : function() {
							var _1 = dojo.i18n.getLocalization("dijit",
									"common");
							dojo.mixin(this, _1);
						...
						_setup : function() {
							...
							var _6 = {
								dialogId : this.id,
								"class" : dojo.map(this["class"].split(/\s/),
										function(s) {
											return s + "_underlay";
										}).join(" ")
							};
							...
							if (!_8) {
								_8 = dijit._underlay = new dijit.DialogUnderlay(
										_6);
							}
						...
						_onKey : function(evt) {
							if (evt.charOrCode) {
								...
								if (_12 == this._firstFocusItem && evt.shiftKey
											...
											.connect(
													...
													function() {
														...
														if (!this._oldViewport
																|| _14.h != this._oldViewport.h
																|| _14.w != this._oldViewport.w) {
															this.layout();
						...
						hide : function() {
							...
							this._modalconnects = [];
							if (this.refocus) {
								this.connect(this._fadeOut, "onEnd",
										dojo.hitch(dijit, "focus",
												this._savedFocus));
							}
						...
						_onCloseEnter : function() {
							dojo.addClass(this.closeButtonNode,
									"dijitDialogCloseIcon-hover");
						},
						_onCloseLeave : function() {
							dojo.removeClass(this.closeButtonNode,
									"dijitDialogCloseIcon-hover");
						}
