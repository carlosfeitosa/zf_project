...
INSERT INTO `adminmenu` VALUES(39, 'modify category', 2, '', 33, 'termcategory', 'modify');
	...
	REPLACE INTO `adminmenu`
	SET `id` = 19, `caption` = 'pessoasperfis management', `order` = 7,
	`description` = 'pessoasperfis management submodule', `parent` = 0,
	`controller` = 'pessoasperfis', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 20, `caption` = 'add pessoasperfis', `order` = 1,
    `description` = 'Use this functionality to add new pessoasperfis items to the system', `parent` = 19,
    `controller` = 'pessoasperfis', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 21, `caption` = 'modify pessoasperfis', `order` = 2,
    `description` = 'Use this functionality to modify existing pessoasperfis items', `parent` = 19,
    `controller` = 'pessoasperfis', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 22, `caption` = 'log management', `order` = 8,
	`description` = 'log management submodule', `parent` = 0,
	`controller` = 'log', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 23, `caption` = 'add log', `order` = 1,
    `description` = 'Use this functionality to add new log items to the system', `parent` = 22,
    `controller` = 'log', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 24, `caption` = 'modify log', `order` = 2,
    `description` = 'Use this functionality to modify existing log items', `parent` = 22,
    `controller` = 'log', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 25, `caption` = 'tipocategoria management', `order` = 9,
	`description` = 'tipocategoria management submodule', `parent` = 0,
	`controller` = 'tipocategoria', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 26, `caption` = 'add tipocategoria', `order` = 1,
    `description` = 'Use this functionality to add new tipocategoria items to the system', `parent` = 25,
    `controller` = 'tipocategoria', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 27, `caption` = 'modify tipocategoria', `order` = 2,
    `description` = 'Use this functionality to modify existing tipocategoria items', `parent` = 25,
    `controller` = 'tipocategoria', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 28, `caption` = 'dadospessoais management', `order` = 10,
	`description` = 'dadospessoais management submodule', `parent` = 0,
	`controller` = 'dadospessoais', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 29, `caption` = 'add dadospessoais', `order` = 1,
    `description` = 'Use this functionality to add new dadospessoais items to the system', `parent` = 28,
    `controller` = 'dadospessoais', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 30, `caption` = 'modify dadospessoais', `order` = 2,
    `description` = 'Use this functionality to modify existing dadospessoais items', `parent` = 28,
    `controller` = 'dadospessoais', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 31, `caption` = 'mensageiro management', `order` = 11,
	`description` = 'mensageiro management submodule', `parent` = 0,
	`controller` = 'mensageiro', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 32, `caption` = 'add mensageiro', `order` = 1,
    `description` = 'Use this functionality to add new mensageiro items to the system', `parent` = 31,
    `controller` = 'mensageiro', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 33, `caption` = 'modify mensageiro', `order` = 2,
    `description` = 'Use this functionality to modify existing mensageiro items', `parent` = 31,
    `controller` = 'mensageiro', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 34, `caption` = 'gerador management', `order` = 12,
	`description` = 'gerador management submodule', `parent` = 0,
	`controller` = 'gerador', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 35, `caption` = 'add gerador', `order` = 1,
    `description` = 'Use this functionality to add new gerador items to the system', `parent` = 34,
    `controller` = 'gerador', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 36, `caption` = 'modify gerador', `order` = 2,
    `description` = 'Use this functionality to modify existing gerador items', `parent` = 34,
    `controller` = 'gerador', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 37, `caption` = 'geradoruniqueid management', `order` = 13,
	`description` = 'geradoruniqueid management submodule', `parent` = 0,
	`controller` = 'geradoruniqueid', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 38, `caption` = 'add geradoruniqueid', `order` = 1,
    `description` = 'Use this functionality to add new geradoruniqueid items to the system', `parent` = 37,
    `controller` = 'geradoruniqueid', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 39, `caption` = 'modify geradoruniqueid', `order` = 2,
    `description` = 'Use this functionality to modify existing geradoruniqueid items', `parent` = 37,
    `controller` = 'geradoruniqueid', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 40, `caption` = 'mensagememail management', `order` = 14,
	`description` = 'mensagememail management submodule', `parent` = 0,
	`controller` = 'mensagememail', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 41, `caption` = 'add mensagememail', `order` = 1,
    `description` = 'Use this functionality to add new mensagememail items to the system', `parent` = 40,
    `controller` = 'mensagememail', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 42, `caption` = 'modify mensagememail', `order` = 2,
    `description` = 'Use this functionality to modify existing mensagememail items', `parent` = 40,
    `controller` = 'mensagememail', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 43, `caption` = 'mensagem management', `order` = 15,
	`description` = 'mensagem management submodule', `parent` = 0,
	`controller` = 'mensagem', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 44, `caption` = 'add mensagem', `order` = 1,
    `description` = 'Use this functionality to add new mensagem items to the system', `parent` = 43,
    `controller` = 'mensagem', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 45, `caption` = 'modify mensagem', `order` = 2,
    `description` = 'Use this functionality to modify existing mensagem items', `parent` = 43,
    `controller` = 'mensagem', `action` = 'modify';

	REPLACE INTO `adminmenu`
	SET `id` = 46, `caption` = 'anexomensagem management', `order` = 16,
	`description` = 'anexomensagem management submodule', `parent` = 0,
	`controller` = 'anexomensagem', `action` = 'index';
	
    REPLACE INTO `adminmenu`
    SET `id` = 47, `caption` = 'add anexomensagem', `order` = 1,
    `description` = 'Use this functionality to add new anexomensagem items to the system', `parent` = 46,
    `controller` = 'anexomensagem', `action` = 'add';
	
	REPLACE INTO `adminmenu`
    SET `id` = 48, `caption` = 'modify anexomensagem', `order` = 2,
    `description` = 'Use this functionality to modify existing anexomensagem items', `parent` = 46,
...
(
    ...
    `xml` varchar(100) NOT NULL default '',
    `pessoasperfis` int(11) NOT NULL default 0,
    `categoria` int(11) NOT NULL default 0,
	PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
