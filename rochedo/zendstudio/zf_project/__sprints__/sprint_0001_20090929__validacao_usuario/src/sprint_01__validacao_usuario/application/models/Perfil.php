 ...
 * 
 * @uses       Default_Model_PerfilMapper
 * @subpackage Model
 */
class Default_Model_Perfil
{
	/**
	* @var int
	*/
	...
	/**
	 * @var Default_Model_PerfilMapper
	 */
	protected $_mapper;
	...
	* Get data mapper
	*
	* Lazy loads Default_Model_PerfilMapper instance if no mapper registered.
	* 
	...
	*/
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Default_Model_PerfilMapper());
		}
		return $this->_mapper;
	}
...
//#BlockStart number=61 id=_K_IikKoJEd687LtTWUTtuQ_#_0
