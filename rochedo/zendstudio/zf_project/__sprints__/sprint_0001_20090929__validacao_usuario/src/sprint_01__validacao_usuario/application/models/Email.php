 ...
 * 
 * @uses       Default_Model_EmailMapper
 * @subpackage Model
 */
class Default_Model_Email
{
	...
	* @return Default_Model_DataHoraUltimaValidacao
	*/
	...
	* Get data mapper
	*
	* Lazy loads Default_Model_EmailMapper instance if no mapper registered.
	* 
...
//#BlockStart number=22 id=_oQ1w0KoDEd687LtTWUTtuQ_#_0
