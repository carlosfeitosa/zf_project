 ...
 * 
 * @uses       Default_Model_PessoaPerfilMapper
 * @subpackage Model
 */
class Default_Model_PessoaPerfil
{
    /**
    * @var int
    */
    ...
    /**
     * @var Default_Model_PessoaPerfilMapper
     */
    protected $_mapper;
    ...
    * Get data mapper
    *
    * Lazy loads Default_Model_PessoaPerfilMapper instance if no mapper registered.
    * 
    ...
    */
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Default_Model_PessoaPerfilMapper());
        }
        return $this->_mapper;
    }
