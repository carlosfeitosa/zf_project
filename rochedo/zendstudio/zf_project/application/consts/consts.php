...
define("TITULO_REGISTRO_NOVO_USUARIO", "TITULO_REGISTRO_NOVO_USUARIO");
define("SUBTITULO_REGISTRO_NOVO_USUARIO", "SUBTITULO_REGISTRO_NOVO_USUARIO");

// reenvio de e-mail de confirmação de novo usuário
define("TITULO_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO", "TITULO_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO");
define("SUBTITULO_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO", "SUBTITULO_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO");
define("MENSAGEM_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO", "MENSAGEM_REENVIO_EMAIL_CONFIRMACAO_NOVO_USUARIO");

// confirmação de usuário já existente e validado
define("TITULO_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE", "TITULO_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE");
define("SUBTITULO_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE", "SUBTITULO_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE");
define("MENSAGEM_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE", "MENSAGEM_EMAIL_CONFIRMACAO_USUARIO_JA_EXISTENTE");

// envio de mensagem para validação
define("TITULO_SUCESSO_ENVIO_CONFIRMACAO_USUARIO", "TITULO_SUCESSO_ENVIO_CONFIRMACAO_USUARIO");
define("SUBTITULO_SUCESSO_ENVIO_CONFIRMACAO_USUARIO", "SUBTITULO_SUCESSO_ENVIO_CONFIRMACAO_USUARIO");
define("MENSAGEM_SUCESSO_ENVIO_CONFIRMACAO_USUARIO", "MENSAGEM_SUCESSO_ENVIO_CONFIRMACAO_USUARIO");

// misc
define("REGISTRE_SE", "REGISTRE_SE");
define("FORM_NOME", "FORM_NOME");
