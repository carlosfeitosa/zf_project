...
define("LOG_MSG_NOVO_DICIONARIO_DADOS_SCHEMA", "Novo schema inserido no banco de dados.");
define("LOG_MSG_UPDATE_DICIONARIO_DADOS_SCHEMA", "Atualizacao de schema no banco de dados.");
define("LOG_MSG_DELETE_DICIONARIO_DADOS_SCHEMA", "Exclusão de schema no banco de dados.");
define("LOG_MSG_NOVO_DICIONARIO_DADOS_ASSOC_TABLE", "Novo assoc table inserido no banco de dados.");
define("LOG_MSG_UPDATE_DICIONARIO_DADOS_ASSOC_TABLE", "Atualizacao de assoc table no banco de dados.");
define("LOG_MSG_DELETE_DICIONARIO_DADOS_ASSOC_TABLE", "Exclusão de assoc table no banco de dados.");
define("LOG_MSG_NOVO_DICIONARIO_DADOS_ASSOC_FIELD", "Novo assoc field inserido no banco de dados.");
define("LOG_MSG_UPDATE_DICIONARIO_DADOS_ASSOC_FIELD", "Atualizacao de assoc field no banco de dados.");
define("LOG_MSG_DELETE_DICIONARIO_DADOS_ASSOC_FIELD", "Exclusão de assoc field no banco de dados.");
define("LOG_MSG_NOVO_DICIONARIO_DADOS_ASSOCCL_FK", "Novo assoccl fk inserido no banco de dados.");
define("LOG_MSG_UPDATE_DICIONARIO_DADOS_ASSOCCL_FK", "Atualizacao de assoccl fk no banco de dados.");
define("LOG_MSG_DELETE_DICIONARIO_DADOS_ASSOCCL_FK", "Exclusão de assoccl fk no banco de dados.");
...
define("LOG_MSG_NOVO_ESTADO", "Novo estado inserido no banco de dados.");
define("LOG_MSG_UPDATE_ESTADO", "Atualizacao do estado no banco de dados.");
define("LOG_MSG_DELETE_ESTADO", "Exclusão do estado no banco de dados.");
