...
class Basico_ValidacaoControllerController
{
    ...
    /**
     * Construtor do controlador Basico_ValidacaoControllerController
     * 
     * @return void
     */
	 ...
	 * @return Basico_ValidacaoControllerController
	 */
	public static function getInstance()
	{
		...
		if (self::$_singleton == NULL){
			...
			self::$_singleton = new Basico_ValidacaoControllerController();
		}
	...
	public function salvaFormularioSessao($objFormulario)
	{
		...
		return Basico_UtilControllerController::registraValorSessao($valorChaveSessaoFormulario, $objFormulario);
	}
	...
	public function recuperaFormularioSessao($chave)
	{
		...
		return Basico_UtilControllerController::retornaValorSessao($chave);
	}
