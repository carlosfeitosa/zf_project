...
class Basico_OPController_FormularioElementoOPController extends Basico_AbstractOPController_RochedoPersistentOPController
{
	...
	public function retornaArrayDadosElementosPorArrayIdsElementos(array $arrayIdsElementos)
	{
		...
		$arrayDadosElementos = $this->_retornaArrayDadosObjetosPorParametros("id in ({$stringIdsElementos})", null, null, null, array('id', 'idCategoria', 'idComponente', 'idAjuda', 'constanteTextualLabel', 'element', 'elementName', 'elementAttribs', 'elementOptions', 'elementValueDefault', 'elementReloadable'));
