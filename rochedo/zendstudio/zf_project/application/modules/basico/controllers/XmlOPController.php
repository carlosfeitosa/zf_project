<?php
/**
 * Controlador Basico_OPController_XmlOPController.
 * 
 * Responsável por conversões xml
 *
 * @author Carlos Feitosa (carlos.feitosa@rochedoframework.com)
 * @since 12/04/2012
 * @author Jeremy Pyne <jeremy.pyne@gmail.com>
 * @license CC:BY/NC/SA  http://creativecommons.org/licenses/by-nc-sa/3.0/
 * @see http://pynej.blogspot.com.br/2010/02/convert-xml-to-array-and-array-to-xml.html
 * 
 */
final class Basico_OPController_XmlOPController
{
	/**
