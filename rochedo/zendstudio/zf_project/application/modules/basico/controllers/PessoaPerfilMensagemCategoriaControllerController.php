...
class Basico_PessoaPerfilMensagemCategoriaControllerController
{
	...
	public function salvarPessoaPerfilMensagemCategoria(Basico_Model_PessoaPerfilMensagemCategoria $novaPessoaPerfilMensagemCategoria)
	{
		try {
			...
			Basico_PersistenceControllerController::bdSave($novaPessoaPerfilMensagemCategoria, null, Basico_PersistenceControllerController::bdRetornaIdPessoaPerfilSistema(), Basico_CategoriaControllerController::retornaIdCategoriaLogNovaPessoaPerfilMensagemCategoria(), LOG_MSG_NOVA_PESSOA_PERFIL_MENSAGEM_CATEGORIA);
