	...
	public static function retornaTipoSanguineoOptions()
	{
		...
		if (count($objTipoSanguineo) > 0) {
			foreach ($objTipoSanguineo as $tipoSanguineo) {
				$arrayResult[$tipoSanguineo->id] = str_replace(TAG_SELECT_OPTION_NAO_DESEJO_INFORMAR, Basico_OPController_DicionarioExpressaoOPController::retornaTraducaoViaSQL("SELECT_OPTION_NAO_DESEJO_INFORMAR") ,$tipoSanguineo->rotulo);
			}
