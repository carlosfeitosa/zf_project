...
class Basico_Controller_Plugin_ActionControllerRenderControlHandler extends Zend_Controller_Plugin_Abstract implements Basico_Controller_Plugin_Interface_RochedoPluginGenerico
{
	/**
	...
	{
		$renderizar = Zend_Controller_Action_HelperBroker::getStaticHelper('Renderizar');
