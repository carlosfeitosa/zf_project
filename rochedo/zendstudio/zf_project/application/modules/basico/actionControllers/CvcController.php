...
class Basico_CvcController extends Zend_Controller_Action
{
    ...
    public function resolveconflitoversaoobjetoAction()
    {
    	...
    	$jsVisualizarDadosAtuais = Basico_OPController_UtilOPController::retornaJavaScriptDojoDialogMensagemViaArrayInfo('resolvedorConflitoObjetosVisualizarDados', Basico_OPController_TradutorOPController::retornaTraducaoViaSQL('DIALOG_FORM_RESOLVEDOR_CONFLITO_VISUALIZAR_DADOS_ATUAIS_TITLE'), Basico_OPController_CVCOPController::getInstance()->retornaArrayAtributosObjeto($nomeObjetoConflito, $idObjetoConflito));
