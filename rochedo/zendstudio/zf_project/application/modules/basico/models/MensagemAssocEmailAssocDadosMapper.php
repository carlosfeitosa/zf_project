 ...
 * @subpackage Model
 */
class Basico_Model_MensagemAssocEmailAssocDadosMapper extends Abstract_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Interface_RochedoMapperPersistencia
{
    /**
    ...
    {
        return parent::getDbTable('Basico_Model_DbTable_MensagemAssocEmailAssocDados');
    }
     ...
     * @return void
     */
    public function find($id, Basico_Model_MensagemAssocEmailAssocDados $object)
    {
     ...
     * @return void
     */
    public function save(Basico_Model_MensagemAssocEmailAssocDados $object)
    {
        $data = array(
	...
	* @return void
	*/
	public function delete(Basico_Model_MensagemAssocEmailAssocDados $object)
	{
