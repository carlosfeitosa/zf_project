 ...
 * @subpackage Model
 */
class Basico_Model_AcaoEventoAssocclIncludeMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	/**
    ...
    */ 
	...
	/**
	 * Fetch all AcaoEventoAssocclInclude entries
	 * 
	 * @return array
	 */
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_AcaoEventoAssocclInclude');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_AcaoEventoAssocclInclude', $where, $order, $count, $offset);
	}
    
    /**
     * Save a AcaoEventoAssocclInclude entry
     * 
     * @param  Basico_Model_AcaoEventoAssocclInclude $object
     * 
     * @return void
