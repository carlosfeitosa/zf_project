 ...
 * @subpackage Model
 */
class Basico_Model_FormularioAssocclElementoGrupoAssocclDecoratorMapper extends Abstract_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Interface_RochedoMapperPersistencia
{
    /**
    ...
    {
        return parent::getDbTable('Basico_Model_DbTable_FormularioAssocclElementoGrupoAssocclDecorator');
    }
     ...
     * @return void
     */
    public function find($id, Basico_Model_FormularioAssocclElementoGrupoAssocclDecorator $object)
    {
     ...
     * @return void
     */
    public function save(Basico_Model_FormularioAssocclElementoGrupoAssocclDecorator $object)
    {
        $data = array(
    ...
    * @return void
    */
    public function delete(Basico_Model_FormularioAssocclElementoGrupoAssocclDecorator $object)
    {
