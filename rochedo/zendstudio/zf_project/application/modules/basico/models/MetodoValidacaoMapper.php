...
class Basico_Model_MetodoValidacaoMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	...
	public function __construct()
	{
		...
		$this->_arrayMapper['metodo'] = 'metodo';
    ...
    */ 
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_MetodoValidacao');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_MetodoValidacao', $where, $order, $count, $offset);
	}
