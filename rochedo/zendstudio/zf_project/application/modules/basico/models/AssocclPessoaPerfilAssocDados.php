 ...
 * @subpackage Model
 */
class Basico_Model_AssocclPessoaPerfilAssocDados extends Abstract_RochedoPersistentModeloDados implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
	 * 
	 * @var int
