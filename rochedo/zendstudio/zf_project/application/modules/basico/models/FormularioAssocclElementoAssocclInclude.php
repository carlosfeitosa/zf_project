 ...
 * @subpackage Model
 */
class Basico_Model_FormularioAssocclElementoAssocclInclude extends Abstract_RochedoPersistentModeloAssociacao implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
	 * @var Integer
	 */
