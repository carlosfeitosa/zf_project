 ...
 * @subpackage Model
 */
class Basico_Model_FormularioAssocclElementoAssocclInclude extends Abstract_RochedoPersistentModeloAssociacao implements Interface_RochedoPersistentModeloGenerico
{
	/**
	 * @var Integer
	 */
