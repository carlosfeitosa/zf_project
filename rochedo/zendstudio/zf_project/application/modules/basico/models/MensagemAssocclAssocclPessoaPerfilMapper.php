...
class Basico_Model_MensagemAssocclAssocclPessoaPerfilMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
    ...
    */ 
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_MensagemAssocclAssocclPessoaPerfil');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_MensagemAssocclAssocclPessoaPerfil', $where, $order, $count, $offset);
	}
	...
	/**
	* Delete a MensagemAssocclAssocclPessoaPerfil entry
	* 
	* @param Basico_Model_MensagemAssocclAssocclPessoaPerfil $object
	* 
	* @return void
