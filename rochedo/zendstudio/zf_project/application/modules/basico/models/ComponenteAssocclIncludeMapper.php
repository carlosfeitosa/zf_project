 ...
 * @subpackage Model
 */
class Basico_Model_ComponenteAssocclIncludeMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	/**
    ...
    */ 
    public function getDbTable($dbTable = 'Basico_Model_DbTable_ComponenteAssocclInclude')
    {
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_ComponenteAssocclInclude');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_ComponenteAssocclInclude', $where, $order, $count, $offset);
	}
