<?php
/**
 * VinculoPessoaJuridica model
 *
 * Utilizes the Data Mapper pattern to persist data.
 * 
 * @uses       Basico_Model_VinculoPessoaJuridicaMapper
 * @subpackage Model
 */
class Basico_Model_VinculoPessoaJuridica
{
	/**
	* @var int
	*/
	...
	/**
	 * @var Basico_Model_VinculoPessoaJuridicaMapper
	 */
	protected $_mapper;
	 ...
	 * 
	 * @param  array $options 
	 * @return Basico_Model_VinculoPessoaJuridica
	 */
	...
	* Get data mapper
	*
	* Lazy loads Basico_Model_VinculoPessoaJuridicaMapper instance if no mapper registered.
	* 
	...
	*/
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Basico_Model_VinculoPessoaJuridicaMapper());
		}
		return $this->_mapper;
	}
