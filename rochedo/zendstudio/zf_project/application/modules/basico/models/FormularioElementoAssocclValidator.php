 ...
 * @subpackage Model
 */
class Basico_Model_FormularioElementoAssocclValidator extends Abstract_RochedoPersistentModeloAssociacao implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
    /**
     * @var int
     */
