 ...
 * @subpackage Model
 */
class Basico_Model_AcaoAplicacaoAssocclMetodoValidacao extends Abstract_RochedoPersistentModeloAssociacao implements Interface_RochedoPersistentModeloGenerico
{
    /**
     * @var int
     */
