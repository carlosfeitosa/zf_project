 ...
 * 
 * @uses       Basico_Model_WebSiteMapper
 * @subpackage Model
 */
class Basico_Model_WebSite
{
	/**
	* @var int
	*/
	...
	/**
	 * @var Basico_Model_WebSiteMapper
	 */
	protected $_mapper;
	...
	* Get data mapper
	*
	* Lazy loads Basico_Model_WebSiteMapper instance if no mapper registered.
	* 
	...
	*/
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Basico_Model_WebSiteMapper());
		}
		return $this->_mapper;
	}
