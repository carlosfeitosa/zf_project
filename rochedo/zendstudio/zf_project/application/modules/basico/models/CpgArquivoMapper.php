...
class Basico_Model_CpgArquivoMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	...
	public function __construct()
	{
		...
		$this->_arrayMapper['nomeOriginal'] 	 		 = 'nome_original';
		$this->_arrayMapper['nomeSugestao'] 	 		 = 'nome_sugestao';
		$this->_arrayMapper['tamanhoKylobytes'] 	 	 = 'tamanho_kylobytes';
		$this->_arrayMapper['mimeType'] 	 			 = 'mime_type';
		$this->_arrayMapper['uri'] 	 				 	 = 'uri';
		$this->_arrayMapper['remoto'] 	 				 = 'remoto';
		$this->_arrayMapper['hits'] 	 				 = 'hits';
    ...
    */ 
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_CpgArquivo');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_CpgArquivo', $where, $order, $count, $offset);
	}
