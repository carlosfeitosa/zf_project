 ...
 * @subpackage Model
 */
class Basico_Model_TemplateMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	/**
	...
	public function __construct()
	{
		...
		$this->_arrayMapper['template'] = 'template';
    ...
    */ 
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_Template');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_Template', $where, $order, $count, $offset);
	}
