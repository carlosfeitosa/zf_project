 ...
 * @subpackage Model
 */
class Basico_Model_CategoriaAssocChaveEstrangeira extends Abstract_RochedoPersistentModeloGenerico implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
	 * @var int
	 */
