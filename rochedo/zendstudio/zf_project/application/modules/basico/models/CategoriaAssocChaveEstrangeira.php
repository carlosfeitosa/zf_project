 ...
 * @subpackage Model
 */
class Basico_Model_CategoriaAssocChaveEstrangeira extends Abstract_RochedoPersistentModeloGenerico implements Interface_RochedoPersistentModeloGenerico
{
	/**
	 * @var int
	 */
