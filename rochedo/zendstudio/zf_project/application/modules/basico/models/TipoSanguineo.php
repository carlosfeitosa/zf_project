 ...
 * 
 * @uses       Basico_Model_TipoSanguineoMapper
 * @subpackage Model
 */
class Basico_Model_TipoSanguineo
{
	/**
	* @var int
	*/
	...
	/**
	 * @var Basico_Model_TipoSanguineoMapper
	 */
	protected $_mapper;
	...
	* Get data mapper
	*
	* Lazy loads Basico_Model_TipoSanguineoMapper instance if no mapper registered.
	* 
	...
	*/
	public function getMapper()
	{
		if (null === $this->_mapper) {
			$this->setMapper(new Basico_Model_TipoSanguineoMapper());
		}
		return $this->_mapper;
	}
