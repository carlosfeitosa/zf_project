 ...
 * 
 * @uses       Basico_Model_FilterGrupoMapper
 * @subpackage Model
 */

class Basico_Model_FilterGrupo extends Basico_AbstractModel_RochedoPersistentModeloDados implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
     * @var Int
     */
	...
	* @return Basico_Model_FilterGrupo
	*/
	...
	* Get data mapper
	*
	* Lazy loads Basico_Model_FilterGrupoMapper instance if no mapper registered.
	* 
	* @return Basico_Model_FilterGrupoMapper
	*/
	public function getMapper()
	{
		return parent::getMapper('Basico_Model_FilterGrupoMapper');
	}	
}