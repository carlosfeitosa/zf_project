<?php
/**
 * ValidatorGrupo model
 *
 * Utilizes the Data Mapper pattern to persist data.
 * 
 * @uses       Basico_Model_ValidatorGrupoMapper
 * @subpackage Model
 */

class Basico_Model_ValidatorGrupo extends Basico_AbstractModel_RochedoPersistentModeloDados implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
     * @var Int
     */
	...
	* @return Basico_Model_ValidatorGrupo
	*/
	...
	* Get data mapper
	*
	* Lazy loads Basico_Model_ValidatorGrupoMapper instance if no mapper registered.
	* 
	* @return Basico_Model_ValidatorGrupoMapper
	*/
	public function getMapper()
	{
		return parent::getMapper('Basico_Model_ValidatorGrupoMapper');
	}	
}