 ...
 * @subpackage Model
 */
class Basico_Model_AcaoEventoMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	/**
    ...
    */ 
    public function getDbTable($dbTable = 'Basico_Model_DbTable_AcaoEvento')
    {
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_AcaoEvento');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_AcaoEvento', $where, $order, $count, $offset);
	}
