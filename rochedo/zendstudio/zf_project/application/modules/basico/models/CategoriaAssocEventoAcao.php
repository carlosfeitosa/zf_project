 ...
 * @subpackage Model
 */
class Basico_Model_CategoriaAssocEventoAcao extends Basico_AbstractModel_RochedoPersistentModeloDados implements Basico_InterfaceModel_RochedoPersistentModeloGenerico
{
	/**
	* @var int
	*/
	...
	*/
	...
	{
		return parent::getMapper('Basico_Model_CategoriaAssocEventoAcaoMapper');
	}
}