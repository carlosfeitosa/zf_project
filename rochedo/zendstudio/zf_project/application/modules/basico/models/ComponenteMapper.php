 ...
 * @subpackage Model
 */
class Basico_Model_ComponenteMapper extends Basico_AbstractMapper_RochedoMapper implements Basico_InterfaceMapper_RochedoMapperPesquisa, Basico_InterfaceMapper_RochedoMapperPersistencia
{
	/**
	...
	public function __construct()
	{
		...
		$this->_arrayMapper['componente'] 	 			 = 'componente';
    ...
    */ 
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_Componente');
	}
	...
	{
		// chamando método pai
		return $this->fetchListAbstrato($this->_arrayMapper, 'Basico_Model_Componente', $where, $order, $count, $offset);
	}
