...
*/
    ...
    $elements[1]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_CATEGORIA_BOLSA_CNPQ_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_CATEGORIA_BOLSA_CNPQ_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    if ($options!=null)
    ...
    $elements[2]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_MAIOR_TITULACAO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_MAIOR_TITULACAO_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    if ($options!=null)
        $elements[2]->setValue($options->maiorTitulacao);
    ...
    $elements[3]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_INSTITUICAO_QUE_CONCEDEU_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_INSTITUICAO_QUE_CONCEDEU_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[4]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_AREA_DE_CONHECIMENTO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_AREA_DE_CONHECIMENTO_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[5]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_NOME_CURSO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_NOME_CURSO_TEXT_BOX_AJUDA')) . '\', 1)</script></button>');
    $elements[5]->setInvalidMessage($this->getView()->tradutor('FORM_FIELD_NOME_CURSO_TEXT_BOX_HINT'));
    if ($options!=null)
        $elements[5]->setValue($options->nomeCurso);
    ...
    $elements[6]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_DATA_OBTENCAO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_DATA_OBTENCAO_DATE_TEXT_BOX_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[7]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TITULACAO_ESPERADA_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TITULACAO_ESPERADA_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[8]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_INSTITUICAO_CURSO_ATUAL_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_INSTITUICAO_CURSO_ATUAL_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[9]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_AREA_CONHECIMENTO_CURSO_ATUAL_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_AREA_CONHECIMENTO_CURSO_ATUAL_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[10]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_NOME_CURSO_ATUAL_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_NOME_CURSO_ATUAL_TEXT_BOX_AJUDA')) . '\', 1)</script></button>');
    ...
    $elements[11]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_PERIODO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_PERIODO_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');

    $elements[12] = $this->createElement('FilteringSelect', 'BasicoCadastrarDadosUsuarioDadosAcademicosTurno');
    $elements[12]->setOrder(12);
    $elements[12]->setRequired(true);
    ...
    $elements[12]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TURNO_LABEL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarDadosUsuarioDadosAcademicos\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TURNO_FILTERING_SELECT_AJUDA')) . '\', 1)</script></button>');

    $elements[13] = $this->createElement('button', 'BasicoCadastrarDadosUsuarioDadosAcademicosButtonDialogDojo1');
    $elements[13]->setOrder(13);
    $elements[13]->setAttribs(array('label' => "{$this->getView()->tradutor('FORM_BUTTON_ABRIR_DIALOG_VISUALIZAR_POS_GRADUACAO')}", 'onClick' => "exibirDialogUrl(\"Basico_Form_CadastrarDadosUsuarioDadosAcademicosCoordenacaoPosGraduacao\", \"/rochedo_project/public/public_forms/basico/forms/CadastrarDadosUsuarioDadosAcademicosCoordenacaoPosGraduacao." . Basico_PessoaControllerController::retornaLinguaUsuario() . ".html\", \"{$this->getView()->tradutor('FORM_BUTTON_ABRIR_DIALOG_VISUALIZAR_POS_GRADUACAO')}\")"));
