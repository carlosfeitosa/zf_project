...
class Basico_Form_CadastrarTelefone extends Zend_Dojo_Form
{
    ...
    */
    public function __construct($options = null)
    {
        ...
        $elements[0] = $this->createElement('FilteringSelect', 'BasicoCadastrarTelefoneTelefoneTipo');
        ...
        $elements[0]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TELEFONE_TIPO') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_TIPO_AJUDA')) . '\', 1)</script></button>');
        if ($options!=null)
            $elements[0]->setValue($options->telefoneTipo);

        $elements[1] = $this->createElement('NumberTextBox', 'BasicoCadastrarTelefoneTelefoneCodigoPais', array('style' => 'width: 40px;', 'places' => 0, 'pattern' => '##0.##'));
        ...
        $elements[1]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_PAIS') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_PAIS_AJUDA')) . '\', 1)</script></button>');
        $elements[1]->setInvalidMessage($this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_PAIS_HINT'));
        if ($options!=null)
            $elements[1]->setValue($options->telefoneCodigoPais);

        $elements[2] = $this->createElement('NumberTextBox', 'BasicoCadastrarTelefoneTelefoneCodigoArea', array('style' => 'width: 40px;', 'places' => 0, 'pattern' => '##0.##'));
        ...
        $elements[2]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_AREA') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_AREA_AJUDA')) . '\', 1)</script></button>');
        $elements[2]->setInvalidMessage($this->getView()->tradutor('FORM_FIELD_TELEFONE_CODIGO_AREA_HINT'));
        if ($options!=null)
            $elements[2]->setValue($options->telefoneCodigoArea);

        $elements[3] = $this->createElement('NumberTextBox', 'BasicoCadastrarTelefoneTelefone', array('style' => 'width: 70px;', 'places' => 0, 'pattern' => '##0.##'));
        ...
        $elements[3]->setLabel('* ' . $this->getView()->tradutor('FORM_FIELD_TELEFONE') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_AJUDA')) . '\', 1)</script></button>');
        $elements[3]->setInvalidMessage($this->getView()->tradutor('FORM_FIELD_TELEFONE_HINT'));
        if ($options!=null)
            $elements[3]->setValue($options->telefone);

        $elements[4] = $this->createElement('NumberTextBox', 'BasicoCadastrarTelefoneTelefoneRamal', array('style' => 'width: 40px;', 'places' => 0, 'pattern' => '##0.##'));
        ...
        $elements[4]->setLabel('' . $this->getView()->tradutor('FORM_FIELD_TELEFONE_RAMAL') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_RAMAL_AJUDA')) . '\', 1)</script></button>');
        $elements[4]->setInvalidMessage($this->getView()->tradutor('FORM_FIELD_TELEFONE_RAMAL_HINT'));
        if ($options!=null)
            $elements[4]->setValue($options->telefoneRamal);

        $elements[5] = $this->createElement('SimpleTextarea', 'BasicoCadastrarTelefoneTelefoneDescricao', array('style' => 'width: 300px;'));
        ...
        $elements[5]->setLabel('' . $this->getView()->tradutor('FORM_FIELD_TELEFONE_DESCRICAO') . '&nbsp;<button dojoType="dijit.form.Button" type="button">?<script type="dojo/method" event="onClick" args="evt">showDialogAlert(\'CadastrarTelefone\', \'' . $this->getView()->tradutor('DIALOG_HELP_TITLE') . '\', \'' . Basico_UtilControllerController::escapaAspasStringJavascriptPHP($this->getView()->tradutor('FORM_FIELD_TELEFONE_DESCRICAO_AJUDA')) . '\', 1)</script></button>');
        if ($options!=null)
            $elements[5]->setValue($options->telefoneDescricao);

        $elements[6] = $this->createElement('html', 'BasicoCadastrarTelefoneLinhaHorizontal', array('value' => '<hr>'));
        $elements[6]->setRequired(false);
        $elements[6]->addDecorator(array('row' => 'HtmlTag'), array('tag' => 'div', 'id' => 'width100percent-clear-both'));

        $elements[7] = $this->createElement('submitButton', 'BasicoCadastrarTelefoneEnviar');
        ...
        $elements[8] = $this->createElement('button', 'BasicoCadastrarTelefoneResetar', array('type' => 'reset', 'onClick' => 'hideDialog("Basico_Form_CadastrarTelefone");'));
        ...
        $elements[9] = $this->createElement('hidden', 'BasicoCadastrarTelefoneDummyHidden');
