...
class Basico_Form_CadastrarTelefone extends Zend_Dojo_Form
{
    ...
    */
    public function __construct($options = null)
    {
        ...
        if ($options!=null)
            $elements[6]->setValue($options->telefoneDescricao);
        ...
        $elements[9] = $this->createElement('button', 'BasicoCadastrarTelefoneResetar', array('type' => 'reset', 'onClick' => 'hideDialog("Basico_Form_CadastrarTelefone");'));
