...
class Basico_Form_AdminRascunhos extends Zend_Dojo_Form
{
    ...
    */
    public function __construct($options = null)
    {
        ...
        $elements[5] = $this->createElement('html', 'BasicoAdminRascunhosDivTreeResultado', array('value' => ""));
        ...
        $elements[6] = $this->createElement('html', 'BasicoAdminRascunhosDivLegenda', array('value' => ""));
        ...
        $elements[7] = $this->createElement('button', 'BasicoAdminRascunhosHtmlButtonAbrir');
        ...
        $elements[8] = $this->createElement('button', 'BasicoAdminRascunhosHtmlButtonFinalizar');
        ...
        $elements[9] = $this->createElement('button', 'BasicoAdminRascunhosHtmlButtonDescartar');
        ...
        $elements[10] = $this->createElement('button', 'BasicoAdminRascunhosHtmlButtonFechar');
