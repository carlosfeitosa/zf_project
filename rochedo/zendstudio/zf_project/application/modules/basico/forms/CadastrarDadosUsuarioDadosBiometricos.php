...
*/
class Basico_Form_CadastrarDadosUsuarioDadosBiometricos extends Zend_Dojo_Form
{
    /**
    * Constructor do Form
    * @param array $options
    * @return Basico_Form_CadastrarDadosUsuarioDadosBiometricos
    */
    public function __construct($options = null)
    {
        ...
        $this->setName('CadastrarDadosUsuarioDadosBiometricos');
        $this->setMethod('post');
