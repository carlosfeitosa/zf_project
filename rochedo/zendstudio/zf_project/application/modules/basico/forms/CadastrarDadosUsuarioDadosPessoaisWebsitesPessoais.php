...
*/
class Basico_Form_CadastrarDadosUsuarioDadosPessoaisWebsitesPessoais extends Zend_Dojo_Form
{
    /**
    * Constructor do Form
    * @param array $options
    * @return Basico_Form_CadastrarDadosUsuarioDadosPessoaisWebsitesPessoais
    */
    public function __construct($options = null)
    {
        ...
        $this->setName('BasicoCadastrarDadosUsuarioDadosPessoaisWebsitesPessoais');
        $this->setMethod('post');
        ...
        $elements[1] = $this->createElement('html', 'BasicoCadastrarDadosUsuarioDadosPessoaisWebsitesPessoaisLinhaHorizontal', array('value' => '<hr>'));
        ...
        $elements[2] = $this->createElement('button', 'BasicoCadastrarDadosUsuarioDadosPessoaisWebsitesPessoaisButtonDialogDojo1');
        ...
        $elements[3] = $this->createElement('button', 'BasicoCadastrarDadosUsuarioDadosPessoaisWebsitesPessoaisFechar', array('onClick' => 'hideDialog(\"Basico_Form_CadastrarDadosUsuarioDadosPessoaisWebsitesPessoais\");'));
