 ...
 * 
 * @uses       GC_Model_ArquivoPerfilMapper
 * @subpackage Model
 */
class GC_Model_ArquivoPerfil
{
    /**
    * @var int
    */
    ...
    /**
     * @var GC_Model_ArquivoPerfilMapper
     */
    protected $_mapper;
    ...
    */
     ...
     * @return null|Arquivo
     */
    public function getArquivoObject()
    {
        $model = new GC_Model_Arquivo();
        $object = $model->find($this->_arquivo);
        return $object;
    }
    ...
    * Get data mapper
    *
    * Lazy loads GC_Model_ArquivoPerfilMapper instance if no mapper registered.
    * 
    ...
    */
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new GC_Model_ArquivoPerfilMapper());
        }
        return $this->_mapper;
    }
